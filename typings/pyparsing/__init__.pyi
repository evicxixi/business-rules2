...
def conditionAsParseAction(fn, message=..., fatal=...):
    ...
...
class ParseResults(object):
    ...
    prints::
        ...
        - year: 1999
    """
    def __new__(cls, toklist=..., name=..., asList=..., modal=...):
        ...
    ...
    def asXML(self, doctag=..., namedItemsOnly=..., indent=..., formatted=...):
        """
    ...
    def dump(self, indent=..., full=..., include_list=..., _depth=...):
        """
...
class ParserElement(object):
    ...
    def setResultsName(self, name, listAllMatches=...):
        """
    ...
    _packratEnabled = ...
    @staticmethod
    def enablePackrat(cache_size_limit=...):
    ...
    def parseString(self, instring, parseAll=...):
        """
    ...
    def scanString(self, instring, maxMatches=..., overlap=...):
        """
    ...
    def split(self, instring, maxsplit=..., includeSeparators=...):
        """
    ...
    def parseFile(self, file_or_filename, parseAll=...):
        """
    ...
    def matches(self, testString, parseAll=...):
        """
    ...
    def runTests(self, tests, parseAll=..., comment=..., fullDump=..., printResults=..., failureTests=..., postParse=..., file=...):
        """
...
class Regex(Token):
    ...
    def parseImplAsGroupList(self, instring, loc, doActions=...):
        ...
    
    def parseImplAsMatch(self, instring, loc, doActions=...):
        ...
...
def delimitedList(expr, delim=..., combine=...):
...
def oneOf(strs, caseless=..., useRegex=..., asKeyword=...):
...
def originalTextFor(expr, asString=...):
...
def nestedExpr(opener=..., closer=..., content=..., ignoreExpr=...):
...
def indentedBlock(blockStatementExpr, indentStack, indent=...):
...
class pyparsing_test:
    ...
    class TestParseResultsAsserts:
        ...
        """
        def assertParseResultsEquals(self, result, expected_list=..., expected_dict=..., msg=...):
            """
        ...
        def assertParseAndCheckList(self, expr, test_string, expected_list, msg=..., verbose=...):
            """
        ...
        def assertParseAndCheckDict(self, expr, test_string, expected_dict, msg=..., verbose=...):
            """
            Convenience wrapper assert to test a parser element and input string, and assert that
        ...
        def assertRunTestResults(self, run_tests_report, expected_parse_results=..., msg=...):
            """
        ...
        @contextmanager
        def assertRaisesParseException(self, exc_type=..., msg=...):
            ...
